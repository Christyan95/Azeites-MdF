...
@Composable
fun minhaTelaClienteInserir(modifier: Modifier = Modifier) {
    ...
    if(carregamento){
        ...
        Column(
            ...
            Text("  - Inserir Clientes | Azeites MdF - ",
                fontSize = 25.sp,
            ...
            Button(
                onClick = {
                    carregamento = true
                    val cliente = Cliente(text_cpf.text,text_nome.text,text_telefone.text,text_endereco.text)
                    ...
                    referencia.child(cliente.cpf).setValue(cliente)
                        ...
                        .addOnFailureListener{
                            Toast.makeText(context, "Falha ao inserir o cliente!", Toast.LENGTH_SHORT).show()
                            activity?.finish()
                        }
                },
                modifier = Modifier
                ...
                Text(text = "Inserir Cliente", color = Color(android.graphics.Color.parseColor("#1C2000")), fontWeight = FontWeight.Bold)
            }
        }
    }
}